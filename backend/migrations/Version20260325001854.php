 ...
 */
final class Version20260325001854 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, full_name, avatar FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL, password VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, is_verified BOOLEAN NOT NULL, otp_code VARCHAR(6) DEFAULT NULL, otp_expiry DATETIME DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, full_name, avatar) SELECT id, email, roles, password, full_name, avatar FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
